...
class DaskDataProcessor:
    ...
    def save_performance_metrics(
        self, output_path: str = "../../../results/performance_metrics_dask_50m.json"
    ):
...
def main():
    ...
    medium_dataset = "../../../data/benchmark_50m.csv"  # 5M rows
    large_dataset = "../../../data/benchmark_50m.csv"  # 10M rows

    # Choose dataset to use (start with medium for reasonable performance)
    csv_path = "../../../data/benchmark_50m.csv"  # Change to large_dataset for maximum Spark advantage
