...
class AnomalyDetectorPyTorch:
    ...
    def run_full_comparison(self, data_path: str, output_dir: str = "models/results", sample_size: int = None):
        ...
        training_time, mem_used, train_losses, val_losses = self.train_model(
            train_loader, val_loader, input_dim=X.shape[1], epochs=10
        )
...
if __name__ == "__main__":
    ...
    # Use 1M sample for faster deep learning training
    # Deep learning needs more time per sample than classical ML
