    ...
    with open(output_path, 'w', newline='', encoding='utf-8') as csvfile:
        ...
        for i in range(num_rows):
            ...
            if (i + 1) % 100000 == 0:
                ...
                print(f"Generated {i + 1:,} rows ({(i+1)/num_rows*100:.1f}%) - "
...
if __name__ == "__main__":
    ...
    try:
        ...
        if num_rows < 10000:
            print("Warning: Very small dataset may not show meaningful performance differences")
        elif num_rows > 5000000:
            print("Warning: Very large dataset may take significant time and disk space")
    ...
    generate_multiple = input("\nGenerate multiple sizes for scalability testing? (y/N): ").strip().lower()
